 ...
 * @version 1.0
 */
public class GeocodeDialog extends JDialog implements ActionListener, 
    ListSelectionListener, StreetSegmentSubject
{
  ...
  public GeocodeDialog(final JFrame owner, final Geocoder geocoder)
  {
    ...
    populate(categoryField, new String[] {"Aly","Arc","Ave","Blvd","Br","Brg",
        "Byp","Cir","Cres","Cswy",
        "Ct","Ctr","Cv","Dr","Expy","Fwy","Grd","Hwy","Ln","Loop","Mal","Pass",
        "Path","Pike",
        "Pky","Pl","Plz","Ramp","Rd","Row","Rte","Rue","Run","Spur","Sq","St",
        "Ter","Tpke",
  ...
  public void actionPerformed(final ActionEvent evt)
  {
    ...
    catch (NumberFormatException nfe)
    {
      ...
      JOptionPane.showMessageDialog(this, 
          slash+numberField.getText()+slash+" is not a valid street number!",
   ...
   * @return The JPanel
   */
  private JPanel createTitledComponent(final String title, 
